...
export default function () {
	return (
		<div className="home-watch-grid">
			<div className="home-watch-grid-column-4">
				<div className="home-watch-grid-column-row-1">
					<div className="home-watch-grid-cell">
						<div className="img-box1">
							<img className="img-watch-responsive" src="./images/tissot-1.jfif" />
						</div>
					</div>
				</div>
				<div className="home-watch-grid-column-row-4">
					<div className="home-watch-grid-cell">
						<div className="home-watch-grid-watch-story">
							Shivasnhu Yadav
        </div>
						<div className="home-watch-grid-watch-details">
			...
			<div className="home-watch-grid-column-3">
				<div className="home-watch-grid-column-row-1">
					<div className="home-watch-grid-cell">
						<div className="home-watch-grid-cell-cell-3">
							<div className="home-watch-grid-watch-name">
								Jaeger Lecoultre Futurematic
          </div>
							<div className="home-watch-grid-watch-desc">
								10K Gold Filled Automatic Bumper Watch 1953
          </div>
						</div>
						<div className="home-watch-grid-cell-cell-1">
						</div>
					</div>
				</div>
				<div className="home-watch-grid-column-row-5">
					<div className="home-watch-grid-cell" />
				</div>
			</div>
		</div>
